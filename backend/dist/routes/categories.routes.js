...
import { validate, createCategorySchema, } from "../schemas/validation.schemas.js";
const router = express.Router();
router.get("/", getAllCategories);
router.post("/", authMiddleware, adminMiddleware, validate(createCategorySchema), createCategory);
router.patch("/:categoryId", authMiddleware, adminMiddleware, validate(createCategorySchema), updateCategory);
