...
import { validate, createOrderSchema, updateOrderSchema, } from "../schemas/validation.schemas.js";
...
router.patch("/:orderId", authMiddleware, adminMiddleware, validate(updateOrderSchema), updateOrder);
